...
namespace Memory {
    ...
    inline void	Hook(AT address, HT hook, ePatchType nType = ePatchType::Nothing) {
        DWORD dwProtect[2];
        switch (nType)
        {
    ...
    inline void CallVirtualMethod(C _this, Args... args) {
